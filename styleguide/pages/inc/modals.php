             ...
             <div class="modal-body">
                 <div class="form-group">
                     ...
                     <select name="addressType" id="addressType">
                         ...
                         <option value="other">Temporary (will show dropdown)</option>
                     </select>
                 </div>
                 <div class="form-group">
             ...
             <div class="modal-body">
                 <div class="form-group">
                     ...
                     <select name="addressType" id="addressType">
                         <option value="ppfone">Home</option>
                         <option value="female">Office</option>
                         <option value="other">Temporary (dropdown opens showing dates)</option>
                     </select>
                 </div>
                 <div class="form-group">
                     <label for="saddress1">Additional Address Line
 ...
 <div class="modal fade modal-mini" id="user" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
     aria-hidden="true">
     <div class="modal-dialog">
         <div class="modal-content">
             <div class="modal-header">
             ...
             <div class="modal-body">
                 <div class="form-group">
                     <label for="sphone">User Setting 1:</label>
                     <input type="text" class="form-control" placeholder="User Setting 1" id="usersetting">
                 </div>
             </div>
             <div class="modal-footer">
                 <button type="button" class="btn btn-sm btn-primary">Add</button>
 ...
 <div class="modal fade modal-mini" id="setup" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
     aria-hidden="true">
     <div class="modal-dialog">
         <div class="modal-content">
             <div class="modal-header">
             ...
             <div class="modal-body">
                 <div class="form-group">
                     <label for="sphone">Setup Option 1:</label>
                     <input type="text" class="form-control" placeholder="Setup Option 1" id="setup">
                 </div>
             </div>
             <div class="modal-footer">
                 <button type="button" class="btn btn-sm btn-primary">Add</button>
